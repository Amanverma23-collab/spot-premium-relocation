...
const CITIES: City[] = [
  { name: "Delhi", lat: 28.6139, lon: 77.209, hub: true },
  { name: "Mumbai", lat: 19.076, lon: 72.8777, hub: true },
...
export const IndiaCoverage = memo(function IndiaCoverage() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative overflow-hidden bg-[var(--navy-deep)] py-20 text-white sm:py-28"
    >
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.2fr]">
          <div className="text-center">
            ...
            <p className="mt-5 text-white/70">
              A logistics network of hubs and route corridors spanning 25+ states. Whether you're
              moving across the city or across the country, we have crews and trucks already in
              motion.
            </p>
          ...
          <div className="relative">
            <div
              className={`glass-panel relative aspect-[3/4] w-full overflow-hidden rounded-[2rem] p-4 sm:aspect-[4/5] ${isMobile ? "map-contain" : ""}`}
            >
              {visible ? (
                <svg
                      ...
                      >
                        ...
                        <circle
                          ...
                          style={{
                            cursor: "pointer",
                            filter: active
                              ? "drop-shadow(0 0 2px rgba(255,200,87,0.9))"
                              : undefined,
                          }}
                        />
                        {(active || c.hub) && (
